 ...
 */
public class FoodFxmlControllerJava {
    String food_name;
    String food_id;
   ...
   FoodFxmlControllerJava(String food_name, String food_id, String food_quantity, String food_price, String food_expire) {
